    ...
    <div className="flex min-h-screen bg-[#0b0f19] text-gray-200">
      ...
      <aside className="w-64 bg-[#0e1325] border-r border-white/10 px-6 py-8">
        ...
        <nav className="space-y-2 text-sm">
          ...
          <NavItem href="/dashboard/ia" label="IA" />
          <NavItem href="/dashboard/projetos" label="Projetos" />
          <NavItem href="/admin/history" label="Histórico" />
          <NavItem href="/dashboard" label="Créditos" />
